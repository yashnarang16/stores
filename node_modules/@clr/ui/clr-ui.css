...
.clr-accordion-header:focus-within, .clr-accordion-header.focus-within {
...
.clr-accordion:not(.clr-stepper-forms) .clr-accordion-description {
  padding: 0.25rem 0.5rem;
  font-size: 0.5rem;
}
...
.clr-stepper-forms .clr-accordion-title {
  width: calc(100% - 3rem);
}
